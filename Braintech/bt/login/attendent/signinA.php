...
<head>
    ...
    <title>BRAINTECH | ATTENDENT LOGIN</title>
    ...
    <div class="page-wrap slate">
        <div class="session-form-hold">
            <div class="card text-center">
                <div class="card-body">
                    <form method="POST" action="attendent/action/checkA.php">
                    <img class="card-img-top signup" src="assets/images/logo.png" alt="Card image cap">
                    <span class="text-primary text-18 d-block font-weight-bold">BrainTech Attendent </span>
                    <span class="mb-md text-muted mb-lg d-block">Sign in to as a Attendent</span>
                    ...
                    <button type="submit" class="btn btn-raised btn-raised-primary btn-block mb-xl" name="submit">Sign In</button>
