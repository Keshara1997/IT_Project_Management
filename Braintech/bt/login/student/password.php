                    ...
                    <div class="page-wrap slate">
                        <div class="session-form-hold">
                            <div class="card text-center">
                                <div class="card-body" >
                                    <form method="POST" action="student/action/passwordController.php?action=check">
                                       ...
                                       <button type="submit" class="btn btn-raised btn-raised-primary btn-block mb-md">Go</button>
                                    </form>
                                </div>
                            </div>
                        </div>
