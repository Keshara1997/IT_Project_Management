                ...
                <div>
                        <div class="ul-header-menu">
                            <ul class="ul-header-nav">
                                ...
                                <li class="ul-menu-item ul-menu-item--active"><a class="ul-menu-link" href="#">Manage Lesson</a></li>
                            </ul>
                        </div>
            ...
            <div class="main-content-body">
                        ...
                        <div class="subheader-main d-none d-lg-flex">
                            <nav class="ul-breadcrumb" aria-label="breadcrumb">
                                <ol class="ul-breadcrumb-items">
                                    ...
                                    <li class="breadcrumb-item"><a href="admin/manageLesson.php">Manage Video Lesson</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-footer text-muted">
                                    <div class="ul-card-list--footer d-flex justify-content-between align-items-center flex-wrap">
                                        <div class=" my-sm">
                                            <!--<a href="admin/LessonPermission.php?&id=<?php echo $result->LessonID ?>"><button type="button" class="btn btn-opacity btn-primary btn-sm">Permission</button></a>-->
                                            <!--<a href="admin/editLesson.php?&id=<?php echo $result->LessonID ?>"><button type="button" class="btn btn-opacity btn-primary btn-sm">Edit</button></a>-->
                                            <a href="admin/action/lessonControllerEm.php?action=delete&id=<?php echo $result->LessonID ?>"><button type="button" class="btn btn-opacity-danger btn-primary btn-sm">Delete</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <h2>Normal Videos</h2><hr>
                    ...
                    <?php    
                    	$CID = test_input($_SESSION['CID']);
                        $CID = mysqli_real_escape_string($mysqli,$CID);
				  		$mydb->setQuery("SELECT * FROM tbllesson WHERE Category='Video' AND CID=$CID ORDER BY LessonChapter DESC, LessonID DESC ");
				  		$cur = $mydb->loadResultList();
                            ...
                            <div class="card">
                                ...
                                <div class="card-footer text-muted">
                                    <div class="ul-card-list--footer d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <a href="admin/LessonPermission.php?&id=<?php echo $result->LessonID ?>"><button type="button" class="btn btn-opacity btn-primary btn-sm">Permission</button></a>
                                            <a href="admin/editLesson.php?&id=<?php echo $result->LessonID ?>"><button type="button" class="btn btn-opacity btn-primary btn-sm">Edit</button></a>
                                            <a href="admin/action/lessonController.php?action=delete&id=<?php echo $result->LessonID ?>" onclick="return confirm('Are you sure you want to delete this item?');"><button type="button" class="btn btn-opacity-danger btn-primary btn-sm">Delete</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
