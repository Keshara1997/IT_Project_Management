                                    ...
                                    <table id="basicDatatable" class="table" style="width:100%">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <a href="admin/submittedEx.php?action=resubmit&ExId=<?php echo $ExId ?>&SUBID=<?php echo $row['ID'] ?>" onclick="return confirm('Are you sure you want to delete this item?');"><button type="button" class="btn btn-opacity-warning">Resubmit</button></a>
