    ...
    <?php include('inc/header.php'); ?>
                ...
                <div>
                        <div class="ul-header-menu">
                            <ul class="ul-header-nav">
                                ...
                                <li class="ul-menu-item ul-menu-item--active"><a class="ul-menu-link" href="admin/addLesson.php">Add Lesson</a></li>
                            </ul>
                        </div>
            ...
            <div class="main-content-body">
                        ...
                        <div class="subheader-main d-none d-lg-flex">
                            <nav class="ul-breadcrumb" aria-label="breadcrumb">
                                <ol class="ul-breadcrumb-items">
                                    ...
                                    <li class="breadcrumb-item"><a href="admin/addLesson.php">Add Lesson</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="container mt-lg">
                    ...
                    <h2 class="doc-section-title" id="examples">Add Lesson<a class="section-link" href="#examples"></a></h2>
                    <div class="doc-example">
                        <div class="row">
                            <div class="col-md-6">
                            <form  id="upload_form" method="POST" enctype="multipart/form-data" action="admin/action/lessonController.php?action=add">
   
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Chapter Name</label>
                                        <input type="text" class="form-control" id="LessonChapter" name="LessonChapter" placeholder="Enter Chapter Name" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Title</label>
                                        <input type="text" class="form-control" id="LessonTitle" name="LessonTitle"  placeholder="Enter Title" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Choes File</label>
                                        <input type="file" name="file"/>
                                    </div>
                                    <button class="btn btn-raised-primary" name="save" type="submit" >Save</button><br>
                                    <progress id="progressBar" value="" max="100" style="width:300px; height:30px;"></progress>
                                    <h3 id="status"></h3>
