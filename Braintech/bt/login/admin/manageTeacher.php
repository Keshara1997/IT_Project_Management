                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php 
                                                        if ($result->ACTIVE == 'DISABLE'){
                                                            echo "<a href='admin/action/teacherActivator.php?status=ACTIVE&id=$result->TEACHER_ID'><button class='btn btn-opacity-success btn-sm' type='button'>Activate</button></a>";
                                                        }else {
                                                            echo "<a href='admin/action/teacherActivator.php?status=DISABLE&id=$result->TEACHER_ID'><button class='btn btn-opacity-danger btn-sm' type='button'>Disable</button></a>";
                                                        }
                                                    ?>
                                                    <a href="admin/action/teacherController.php?action=delete&id=<?php echo $result->TEACHER_ID ?>" onclick="return confirm('Are you sure you want to delete this item?');"><button class="btn text-danger rounded-circle m-0 btn-sm btn-icon"><i class="material-icons">delete</i></button></a>
                                                </td>
                                            </tr>
                                        <?php } ?>   
