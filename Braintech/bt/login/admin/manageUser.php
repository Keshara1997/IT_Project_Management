                ...
                <div>
                        <div class="ul-header-menu">
                            <ul class="ul-header-nav">
                                ...
                                <li class="ul-menu-item ul-menu-item--active"><a class="ul-menu-link">Manage Teachers</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="subheader-main d-none d-lg-flex">
                            <nav class="ul-breadcrumb" aria-label="breadcrumb">
                                <ol class="ul-breadcrumb-items">
                                    ...
                                    <li class="breadcrumb-item"><a >Manage Teachers</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-header">
                                <h2 class="p-1 m-0 text-16 font-weight-semi">Teachers</h2>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    <table id="basicDatatable" class="table" style="width:100%">
                                        ...
                                        <?php 
                                            ...
                                            $query = "SELECT * FROM `courseaccess` c, `tbteacher` t  WHERE t.`TEACHER_ID`=c.`TEACHER_ID` AND c.CID = $CID";
                                            $mydb->setQuery($query);
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="admin/action/givePermition.php?action=delete&id=<?php echo $result->TEACHER_ID ?>" onclick="return confirm('Are you sure you want to delete this item?');"><button class="btn btn-opacity-danger btn-sm" type="button">Remove</button></a>
                                                </td>
                                            </tr>
                                        <?php } ?>   
