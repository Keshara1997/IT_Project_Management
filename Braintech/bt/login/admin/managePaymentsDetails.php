                ...
                <div>
                        <div class="ul-header-menu">
                            <ul class="ul-header-nav">
                                ...
                                <li class="ul-menu-item ul-menu-item--active"><a class="ul-menu-link">Manage Payments</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="subheader-main d-none d-lg-flex">
                            <nav class="ul-breadcrumb" aria-label="breadcrumb">
                                <ol class="ul-breadcrumb-items">
                                    ...
                                    <li class="breadcrumb-item"><a >Manage Payments</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <table id="datatableScrollY" class="table" style="width:100%">
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="admin/editPayment.php?id=<?php echo $row['PAYMENT_ID']; ?>&Year=<?php echo $Year?>&Month=<?php echo $Month; ?>"><button class="btn text-primary rounded-circle m-0 btn-sm btn-icon"><i class="material-icons">edit</i></button></a>
                                                    <a href="admin/action/paymentController.php?action=delete&id=<?php echo $row['PAYMENT_ID']; ?>&Year=<?php echo $Year?>&Month=<?php echo $Month; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><button class="btn text-danger rounded-circle m-0 btn-sm btn-icon"><i class="material-icons">delete</i></button></a>
                                                </td>
                                            </tr>
