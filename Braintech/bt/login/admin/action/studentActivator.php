<?php
    ...
    if($status == 'ACTIVE'){
        ...
        if ($result === TRUE) {
            echo "<script>alert('Student Activated Again. This student can signin to the System now!');location='../manageStudent.php';</script>";
        } else {
    ...
    if($status == 'DISABLE'){
        ...
        if ($result === TRUE) {
            echo "<script>alert('Student Disabled. This student can not signin to the System now!');location='../manageStudent.php';</script>";
        } else {
            echo "<script>alert('Error');location='../manageStudent.php';</script>";
        }
    }
