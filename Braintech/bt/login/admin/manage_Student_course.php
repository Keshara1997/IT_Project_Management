                ...
                <div class="container my-lg">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body"><!--<a href='admin/action/blockCourse.php?action=all&status=DISABLE'><button class='btn btn-opacity-primary btn-sm' type='button'>Print Report</button></a>-->
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php 
                                                    ...
                                                    ?>
                                                    <a href="admin/action/StudentCourseController.php?action=delete&id=<?php echo $result->StudentID ?>" onclick="return confirm('Are you sure you want to delete this item?');"><button class="btn btn-opacity-danger btn-sm" type="button">Remove</button></a>
                                                </td>
                                            </tr>
                                        <?php } ?>   
