...
<body>
    ...
    <?php include('inc/headerOne.php'); ?>
            ...
            <div class="container my-lg">
                    ...
                    <?php
                        $result = $mysqli->query("SELECT * FROM tbcourse WHERE CATEGORY='A/L' ORDER BY tbcourse.COURSE_NAME ASC") or die($mysqli->error);
                                ...
                                <div class="card-body">
                                    <div class="ul-list-2 d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center flex-grow-1">
                                            ...
                                            <a href="admin/action/selector.php?id=<?php echo $row['CID']; ?>">
                    ...
                    <?php
                        $result = $mysqli->query("SELECT * FROM tbcourse WHERE CATEGORY='O/L' ORDER BY tbcourse.COURSE_NAME ASC") or die($mysqli->error);
                        while ($row = $result->fetch_assoc()): 
                    ?>
                    ...
                    <?php  endwhile; ?> 
                           ...
                           <?php
                        $result = $mysqli->query("SELECT * FROM tbcourse WHERE CATEGORY='Course' ORDER BY tbcourse.COURSE_NAME ASC") or die($mysqli->error);
                        while ($row = $result->fetch_assoc()): 
                    ?>
                    ...
                    <?php  endwhile; ?>  
                           ...
                           <?php
                        $result = $mysqli->query("SELECT * FROM tbcourse WHERE CATEGORY='Others' ORDER BY tbcourse.COURSE_NAME ASC") or die($mysqli->error);
                        while ($row = $result->fetch_assoc()): 
                    ?>
