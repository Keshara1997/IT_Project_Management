    ...
    <?php include('inc/header.php'); ?>
            ...
            <div class="main-content-body">
                        ...
                        <div class="subheader-main d-none d-lg-flex">
                            <nav class="ul-breadcrumb" aria-label="breadcrumb">
                                <ol class="ul-breadcrumb-items">
                                    ...
                                    <li class="breadcrumb-item"><a href="admin/addLesson.php">Emberd Lesson</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="container mt-lg">
                    ...
                    <h2 class="doc-section-title" id="examples">Emberd Lesson<a class="section-link" href="#examples"></a></h2>
                    <div class="doc-example">
                        <div class="row">
                            <div class="col-md-6">
                            <form  id="upload_form" method="POST" enctype="multipart/form-data" action="admin/action/lessonControllerEm.php?action=add">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="LessonTitle" name="LINK"  placeholder="Enter Title" required>
                                    </div>
