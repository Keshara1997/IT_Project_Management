    ...
    <?php include('inc/headerOne.php'); ?>
            ...
            <!-- End::Main header-->
                ...
                <div class="container mt-lg">
                    ...
                    <h2 class="doc-section-title" id="examples">Add Teacher<a class="section-link" href="#examples"></a></h2>
                    <div class="doc-example">
                        <div class="row">
                            <div class="col-md-12">
                            <form  action="admin/action/teacherController.php?action=add" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  name="NIC" placeholder="NIC NO here" required>
                                    </div> 

                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Age</label>
                                        <input type="text" class="form-control"  name="age" placeholder="Age here" required>
                                    </div> 
