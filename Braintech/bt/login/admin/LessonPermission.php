<?php 
    ...
    $lessonID = test_input($lessonID);
    if(is_numeric($lessonID)){
        echo "<script>alert('Error!');location='action/logout.php;</script>";
    }
?>
                ...
                <div class="container my-lg">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                <a href="admin/action/StudentLessonController.php?action=ALL&LessonID=<?php echo $lessonID; ?>"><button class="btn btn-opacity-primary btn-sm"><strong>Give Access for All  </strong></button></a>
                                <a href="admin/action/StudentLessonController.php?action=ALLREMOVE&LessonID=<?php echo $lessonID; ?>"><button class="btn btn-opacity-danger btn-sm"><strong>Remove Access for All  </strong></button></a>
                                <form method="POST" action="admin/action/StudentLessonController.php?action=addAll&LessonID=<?php echo $lessonID; ?>">
                                <button class="btn btn-opacity-primary btn-sm" id="usersave" name="save" type="submit" ><strong>Give Access for selected students</strong></button>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <?php
                                                    ...
                                                    $CHECK = 0;
                                                    $results = $mysqli->query("SELECT * FROM tblessonpermission WHERE LPLID = $lessonID AND LPSTID = $Student_Id AND LPCID = $CID") or die($mysqli->error);
                                                ...
                                                <?php
                                                    ...
                                                    if ($CHECK == 0){      
                                                ?>
                                                    <a href="admin/action/StudentLessonController.php?id=<?php echo $result->StudentID ?>&action=add&LessonID=<?php echo $lessonID; ?>"><button class="btn btn-opacity-primary btn-sm" type="button">Give Access</button></a>
                                                <?php }else{ ?>
                                                    <a href="admin/action/StudentLessonController.php?id=<?php echo $result->StudentID ?>&action=delete&LessonID=<?php echo $lessonID; ?>"><button class="btn btn-opacity-danger btn-sm" type="button">Remove Access</button></a>
                                                <?php }?>
