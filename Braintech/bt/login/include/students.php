	...
	function find_all_students($name=""){
		...
		$row_count = $mydb->num_rows($cur);//get the number of count
		 ...
		 $user_found = $mydb->loadSingleResult();
			...
			$_SESSION['DOB']      		= $user_found->BIRTHDAY;
			$_SESSION['Address']      	= $user_found->Address;
			$_SESSION['MobileNo']      	= $user_found->MobileNo;
			$_SESSION['Email']      	= $user_found->EMAIL;
			$_SESSION['SCHOOL']      	= $user_found->SCHOOL;
			$_SESSION['STID']      		= $user_found->STID;
		 	$_SESSION['USERNAME'] 		= $user_found->STUDUSERNAME;
			$_SESSION['STUDPASS'] 		= $user_found->STUDPASS; 
			$_SESSION['ACTIVE'] 		= $user_found->ACTIVE; 
		   return true;
		 }else{
		 	return false;
		 }
