<?php 
    ...
    if($action == 'resubmit'){
		...
		echo "<script>alert('This Student can resubmit Now!');location='submittedExT.php?action=no&ExId=$ExId';</script> ";
	}
?>
                                    ...
                                    <table id="basicDatatable" class="table" style="width:100%">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <a href="teacher/submittedExT.php?action=resubmit&ExId=<?php echo $ExId ?>&SUBID=<?php echo $row['ID'] ?>"><button type="button" class="btn btn-opacity-warning">Resubmit</button></a>
                                                </td>
                                            </tr>
