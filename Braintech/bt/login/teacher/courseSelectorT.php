...
<body>
    ...
    <?php include('inc/headerOneT.php'); ?>
            ...
            <div class="container my-lg">
                    ...
                    <?php
                        $TEACHER_ID = test_input($_SESSION['TEACHER_ID']);
                        $TEACHER_ID = mysqli_real_escape_string($mysqli,$TEACHER_ID);
                        $result = $mysqli->query("SELECT * FROM `courseaccess` c,  `tbcourse` s WHERE s.`CID`=c.`CID` AND c.`TEACHER_ID` = $TEACHER_ID") or die($mysqli->error);
                                ...
                                <div class="card-body">
                                    <div class="ul-list-2 d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center flex-grow-1">
                                            ...
                                            <a href="teacher/action/selectorT.php?id=<?php echo $row['CID']; ?>">
