    ...
    <?php include('inc/headerT.php'); ?>
                ...
                <div>
                        <div class="ul-header-menu">
                            <ul class="ul-header-nav">
                                ...
                                <li class="ul-menu-item ul-menu-item--active"><a class="ul-menu-link" href="teacher/addExercisesT.php">Add Exercises</a></li>
                            </ul>
                        </div>
            ...
            <div class="main-content-body">
                        ...
                        <div class="subheader-main d-none d-lg-flex">
                            <nav class="ul-breadcrumb" aria-label="breadcrumb">
                                <ol class="ul-breadcrumb-items">
                                    ...
                                    <li class="breadcrumb-item"><a href="teacher/addExercisesT.php">Add Exercises</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="container mt-lg">
                    ...
                    <h2 class="doc-section-title" id="examples">Add Exercises<a class="section-link" href="#examples"></a></h2>
                    <div class="doc-example">
                        <div class="row">
                            <div class="col-md-6">
                            <form action="teacher/action/ExercisesControllerT.php?action=add" method="POST" enctype="multipart/form-data"> 
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">File (Upload as a PDF file)</label>
