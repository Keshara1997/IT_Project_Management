    ...
    <?php include('inc/headerT.php'); ?>
                ...
                <div>
                        <div class="ul-header-menu">
                            <ul class="ul-header-nav">
                                ...
                                <li class="ul-menu-item ul-menu-item--active"><a class="ul-menu-link" >Change File</a></li>
                            </ul>
                        </div>
            ...
            <div class="main-content-body">
                        ...
                        <div class="subheader-main d-none d-lg-flex">
                            <nav class="ul-breadcrumb" aria-label="breadcrumb">
                                <ol class="ul-breadcrumb-items">
                                    ...
                                    <li class="breadcrumb-item"><a href="teacher/editFileLesson.html">Change File</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="container mt-lg">
                    ...
                    <h2 class="doc-section-title" id="examples">Change File<a class="section-link" href="#examples"></a></h2>
                    <div class="doc-example">
                        <div class="row">
                            <div class="col-md-6">
                            <form action="teacher/action/lessonControllerT.php?action=updatefiles" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <input name="LessonID" type="hidden" value="<?php echo $res->LessonID; ?>">
                                        <label class="exampleInputPassword1"><?php echo $res->LessonChapter ?></label>
                                    </div>
                                    <div class="form-group">
                                        <label class="exampleInputPassword1"><?php echo $res->LessonTitle; ?></label>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Choes File</label><br>
