                ...
                <div>
                        <div class="ul-header-menu">
                            <ul class="ul-header-nav">
                                ...
                                <li class="ul-menu-item ul-menu-item--active"><a class="ul-menu-link" href="teacher/addStudentT.php">Add Student</a></li>
                            </ul>
                        </div>
            ...
            <div class="main-content-body">
                        ...
                        <div class="subheader-main d-none d-lg-flex">
                            <nav class="ul-breadcrumb" aria-label="breadcrumb">
                                <ol class="ul-breadcrumb-items">
                                    ...
                                    <li class="breadcrumb-item"><a href="teacher/addExercisesT.php">Add Student</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="container mt-lg">
                    ...
                    <div class="doc-example">
                        <div class="row">
                            <div class="col-md-6">
                            <form action="teacher/action/studentControllerT.php?action=add" method="POST"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  name="PHONE" placeholder="P.Number here" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Student ID Number</label>
                                        <input type="text" class="form-control"  name="STID" placeholder="ST ID here" required>
                                    </div>
