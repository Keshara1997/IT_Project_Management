                        ...
                        <div class="subheader-main d-none d-lg-flex">
                            <nav class="ul-breadcrumb" aria-label="breadcrumb">
                                <ol class="ul-breadcrumb-items">
                                    ...
                                    <li class="breadcrumb-item"><a href="teacher/manageExercisesT.php">Select Exercises</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <table id="basicDatatable" class="table" style="width:100%">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="teacher/submittedExT.php?ExId=<?php echo $row['ExId']; ?>&action=no"><button type="button" class="btn btn-raised btn-raised-success">Answers</button></a>
                                                </td>
                                            </tr>
                                            <?php  endwhile; ?>    
