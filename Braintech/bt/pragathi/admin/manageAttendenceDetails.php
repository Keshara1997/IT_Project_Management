                                    ...
                                    <table id="datatableScrollY" class="table" style="width:100%">
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="admin/action/attendenceController.php?action=delete&id=<?php echo $row['ST_ATT_ID']; ?>&Year=<?php echo $Year?>&Month=<?php echo $Month; ?>&Date=<?php echo $Date; ?>"><button class="btn text-danger rounded-circle m-0 btn-sm btn-icon"><i class="material-icons">delete</i></button></a>
                                                </td>
                                            </tr>
