    ...
    <?php include('inc/header.php'); ?>
                ...
                <div>
                        <div class="ul-header-menu">
                            <ul class="ul-header-nav">
                                <li class="ul-menu-item ul-menu-item--active"><a class="ul-menu-link" href="admin/addUser.php">Add User</a></li>
                            </ul>
                        </div>
            ...
            <div class="main-content-body">
                        ...
                        <div class="subheader-main d-none d-lg-flex">
                            <nav class="ul-breadcrumb" aria-label="breadcrumb">
                                <ol class="ul-breadcrumb-items">
                                    <li class="breadcrumb-home"><a href="admin/dashboard.php"> <i class="material-icons">home</i></a></li>
                                    <li class="breadcrumb-item"><a >Users</a></li>
                                    <li class="breadcrumb-item"><a href="admin/addUser.php">Add User</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="container mt-lg">
                    ...
                    <h2 class="doc-section-title" id="examples">Add User<a class="section-link" href="#examples"></a></h2>
                    <div class="doc-example">
                        <div class="row">
                            <div class="col-md-6">
                            <form  action="admin/action/userController.php?action=edit" method="POST">
                                <input   name="user_id" type="Hidden" value="<?php echo $singleuser->USERID; ?>">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Name</label>
                                        <input type="text" class="form-control"  name="user_name" value="<?php echo $singleuser->NAME; ?>" required>
                                    </div>  

                                    <div class="form-group">
                                        <label for="exampleInputEmail1">UserName</label>
                                        <input type="text" class="form-control"  name="user_email" value="<?php echo $singleuser->UEMAIL; ?>" required>
                                    </div>
