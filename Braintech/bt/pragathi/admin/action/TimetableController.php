...
<?php 	} 
			...
			if($action == 'edit'){
				if(isset($_POST['save'])){
							...
							$mysqli->query("UPDATE tbtimetable SET CHAPTERNAME='$CHAPTER_NAME', CHAPTERLESSON='$CHAPTER_LESSON', DATE='$DATE' WHERE TTID = $TTID AND CID = $CID") 
							or die($mysqli->error);
