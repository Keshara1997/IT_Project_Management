    ...
    <?php include('inc/header.php'); ?>
            ...
            <div class="main-content-body">
                ...
                <div class="container mt-lg">
                    ...
                    <?php    
                    	$CID = $_SESSION['CID'];
				  		$mydb->setQuery("SELECT * FROM tbllesson WHERE Category='Video' AND CID=$CID ORDER BY `LessonID` DESC");
                                ...
                                <div class="card-footer text-muted">
                                    <div class="ul-card-list--footer d-flex justify-content-between align-items-center flex-wrap">
                                        <div class=" my-sm">
                                            ...
                                            <a href="admin/editFileLesson.php?&id=<?php echo $result->LessonID ?>"><button type="button" class="btn btn-opacity btn-primary btn-sm">Change File</button></a>
                                            <a href="admin/action/lessonController.php?action=delete&id=<?php echo $result->LessonID ?>"><button type="button" class="btn btn-opacity-danger btn-primary btn-sm">Delete</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
