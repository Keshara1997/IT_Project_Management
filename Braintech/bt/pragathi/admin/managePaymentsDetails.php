                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="admin/action/paymentController.php?action=delete&id=<?php echo $row['PAYMENT_ID']; ?>&Year=<?php echo $Year?>&Month=<?php echo $Month; ?>"><button class="btn text-danger rounded-circle m-0 btn-sm btn-icon"><i class="material-icons">delete</i></button></a>
                                                </td>
                                            </tr>
