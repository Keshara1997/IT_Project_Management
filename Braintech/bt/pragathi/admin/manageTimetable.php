                        ...
                        <div class="subheader-main d-none d-lg-flex">
                            <nav class="ul-breadcrumb" aria-label="breadcrumb">
                                <ol class="ul-breadcrumb-items">
                                    ...
                                    <li class="breadcrumb-item"><a href="admin/addExercises.php">Manage Time Table</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-footer text-muted bg-danger ">
                                    <div class="ul-card-list--footer d-flex justify-content-between align-items-center flex-wrap bg-danger ">
                                        ...
                                        <div class=" my-sm">
                                            <a href="admin/editTimetable.php?id=<?php echo $row['TTID']; ?>"><button type="button" class="btn btn-raised btn-raised-primary btn-sm">EDIT</button></a>
                                            <a href="admin/action/TimetableController.php?action=delete&id=<?php echo $row['TTID']; ?>"><button type="button" class="btn btn-raised btn-raised-warning btn-sm">DELETE</button></a>
                                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-footer text-muted bg-secondary ">
                                    <div class="ul-card-list--footer d-flex justify-content-between align-items-center flex-wrap bg-secondary ">
                                        ...
                                        <div class=" my-sm">
                                            <a href="admin/editTimetable.php?id=<?php echo $row['TTID']; ?>"><button type="button" class="btn btn-raised btn-raised-primary btn-sm">EDIT</button></a>
                                            <a href="admin/action/TimetableController.php?action=delete&id=<?php echo $row['TTID']; ?>"><button type="button" class="btn btn-raised btn-raised-danger btn-sm">DELETE</button></a>
                                        </div>
