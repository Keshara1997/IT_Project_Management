                                    ...
                                    <table id="basicDatatable" class="table" style="width:100%">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                ?>
                                                    <a href='admin/action/paymentController.php?action=remove&PID=<?php echo $row['PID']; ?>&month=<?php echo $month; ?>'><button class='btn btn-opacity-danger btn-sm' type='button'>Remove</button></a>
                                                </td>
