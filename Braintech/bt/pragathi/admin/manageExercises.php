                                ...
                                <div class="card-footer text-muted">
                                    <div class="ul-card-list--footer d-flex justify-content-between align-items-center flex-wrap">
                                        <div class=" my-sm">
                                            ...
                                            <a href="admin/action/ExercisesController.php?action=delete&id=<?php echo $row['ExId']; ?>"><button type="button" class="btn btn-opacity-danger btn-primary btn-sm">Delete</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
