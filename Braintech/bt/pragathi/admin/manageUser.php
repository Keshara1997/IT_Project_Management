                                    ...
                                    <table id="basicDatatable" class="table" style="width:100%">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="admin/action/givePermition.php?action=delete&id=<?php echo $result->TEACHER_ID ?>"><button class="btn btn-opacity-danger btn-sm" type="button">Remove</button></a>
                                                </td>
                                            </tr>
                                        <?php } ?>   
