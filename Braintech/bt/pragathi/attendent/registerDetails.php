                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="attendent/action/attendence.php?STID=<?php echo ($STID2) ?>&CID=<?php echo $row['CID']; ?>"><button type="button" class="btn btn-raised btn-raised-primary" accesskey="a">Attend</button></a>
                                                                </td>
                                                            </tr>
                                                        <?php endwhile; ?>
