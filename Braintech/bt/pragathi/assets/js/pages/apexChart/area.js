$(document).ready(function () {
  var options = {
    ...
    series: [{
      name: "STOCK ABC",
      data: apexChartDataSeries.monthDataSeries1.prices
    }],
    title: {
  ...
  var chart = new ApexCharts(
    document.querySelector("#basicArea"),
    options
  );
...
var chart = new ApexCharts(
  document.querySelector("#areaWithNegativeValue"),
  options
);
