    ...
    <?php include('inc/headerT.php'); ?>
                ...
                <div>
                        <div class="ul-header-menu">
                            <ul class="ul-header-nav">
                                ...
                                <li class="ul-menu-item ul-menu-item--active"><a class="ul-menu-link" href="teacher/addExercisesT.php">Edit Time Table</a></li>
                            </ul>
                        </div>
            ...
            <div class="main-content-body">
                        ...
                        <div class="subheader-main d-none d-lg-flex">
                            <nav class="ul-breadcrumb" aria-label="breadcrumb">
                                <ol class="ul-breadcrumb-items">
                                    ...
                                    <li class="breadcrumb-item"><a href="teacher/addExercisesT.php">Edit Time Table</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="container mt-lg">
                    ...
                    <h2 class="doc-section-title" id="examples">Edit Time Table<a class="section-link" href="#examples"></a></h2>
                    <div class="doc-example">
                        <div class="row">
                            <div class="col-md-6">
                            <form action="teacher/action/TimetableControllerT.php?action=edit" method="POST" enctype="multipart/form-data"> 
                         
                            <?php
                                $CID = $_SESSION['CID'];
                                $id = $_GET['id'];
                                $result = $mysqli->query("SELECT * FROM tbtimetable WHERE CID = $CID AND TTID = $id") or die($mysqli->error);
                                while ($row = $result->fetch_assoc()):
                            
                            ?>
                                    <input name="ID" type="hidden" value="<?php echo $row['TTID']; ?>">
         
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Chapter Name</label>
                                        <input type="text" class="form-control" name="CHAPTER_NAME" value="<?php echo $row['CHAPTERNAME']; ?>" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Lesson Name</label>
                                        <input type="text" class="form-control" name="CHAPTER_LESSON" value="<?php echo $row['CHAPTERLESSON']; ?>"required>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Date</label>
                                        <input type="" id="datepicker" width="276" name="DATE" value="<?php echo $row['DATE']; ?>"/>
