                    ...
                    <table width="100%">
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="siteControl/editEvent.php?id=<?php echo $row['EVENT_ID']; ?>"><span><button class="button button2">EDIT</button></span></a>
                                    <a href="siteControl/action/controlEvent.php?action=delete&id=<?php echo $row['EVENT_ID']; ?>"><span><button class="button button3">DELETE</button></span></a>
                                </td>
                            </tr>
