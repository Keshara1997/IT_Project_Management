        ...
        <div class="contact-page-section sec-spacer">
        	<div class="container">
        		...
        		<div class="contact-comment-section">
					...
					<form id="contact-form" method="post" action="siteControl/action/controlTeachers.php?action=add" enctype="multipart/form-data">
						<fieldset>
							<div class="row">                                      
								<div class="col-md-6 col-sm-12">
									<div class="form-group">
										<label>Full Name*</label>
										<input name="FULL_NAME" id="fname" class="form-control" type="text">
									</div>
								</div>
								<div class="col-md-6 col-sm-12">
									<div class="form-group">
                            ...
                            <div class="row">
								<div class="col-md-6 col-sm-12">
									<div class="form-group">
										...
										<input name="TEACHER_IMG" id="subject" class="form-control" type="file">
									</div>
								</div>
                            </div>
                            <br>
                            ...
                            <div class="row">
								<div class="col-md-6 col-sm-12">
									<div class="form-group">
										...
										<input name="FACEBOOK_LINK" id="email" class="form-control" type="text">
									</div>
								</div>
								<div class="col-md-6 col-sm-12">
									<div class="form-group">
										<label>Twitter</label>
										<input name="TWITTER_LINK" id="subject" class="form-control" type="text">
									</div>
								</div>
                            </div>
