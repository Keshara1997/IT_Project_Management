                    ...
                    <table width="100%">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="siteControl/editCourse.php?id=<?php echo $row['COURSE_ID']; ?>"><span><button class="button button2">EDIT</button></span></a>
                                    <a href="siteControl/action/controlCourse.php?action=delete&id=<?php echo $row['COURSE_ID']; ?>"><span><button class="button button3">DELETE</button></span></a>
                                </td>
                            </tr>
                        <?php  endwhile; ?>
