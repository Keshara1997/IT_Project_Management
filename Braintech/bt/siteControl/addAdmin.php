        ...
        <div class="contact-page-section sec-spacer">
        	<div class="container">
        		...
        		<div class="contact-comment-section">
					...
					<form id="contact-form" method="post" action="siteControl/action/controlAdmins.php?action=add" enctype="multipart/form-data">
						<fieldset>
							<div class="row">                                      
								<div class="col-md-6 col-sm-12">
									<div class="form-group">
										<label>Name*</label>
										<input name="NAME" id="fname" class="form-control" type="text">
									</div>
								</div>
							</div>
                            ...
                            <div class="row">
								...
								<div class="col-md-6 col-sm-12">
									<div class="form-group">
										...
										<input name="PASSWORD" id="subject" class="form-control" type="password">
									</div>
								</div>
                            </div>
