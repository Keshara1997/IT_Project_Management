        	...
        	<div class="container">
                ...
                <div class="table">
                    <table width="100%">
                        ...
                        <?php
                            $count = 0;
                            $result = $mysqli->query("SELECT * FROM dbuser ORDER BY dbuser.USER_ID DESC") or die($mysqli->error);
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="siteControl/editAdmin.php?id=<?php echo $row['USER_ID']; ?>"><span><button class="button button2">EDIT</button></span></a>
                                    <a href="siteControl/action/controlAdmins.php?action=delete&id=<?php echo $row['USER_ID']; ?>"><span><button class="button button3">DELETE</button></span></a>
                                </td>
                            </tr>
