        	...
        	<div class="container">
                ...
                <div class="table">
                    <table width="100%">
                        ...
                        <?php
                            $count = 0;
                            $result = $mysqli->query("SELECT * FROM dbmessage ORDER BY dbmessage.M_ID DESC") or die($mysqli->error);
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="siteControl/action/controlMessage.php?action=delete&id=<?php echo $row['M_ID']; ?>"><span><button class="button button3">DELETE</button></span></a>
                                </td>
                            </tr>
